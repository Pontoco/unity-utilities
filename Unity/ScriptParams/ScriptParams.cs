...
{
    /// <summary>
    ///     This is a utility that allows you to store constants for a script as an Asset in Unity. This lets you do a few
    ///     things: - Access script constants under a static, unique path - Update constants while the game is playing and have
    ///     the changes keep. - No manual connection of configuration assets to prefabs/scripts. See <see cref="FlightPaths" />

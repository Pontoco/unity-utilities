...
{
    /// <summary>Logs an error if this object has anything other than the identity transform at Start time.</summary>
    public class AssertIdentityTransform : MonoBehaviour
    {
        ...
        {
            Debug.LogError("Gameobject [" + gameObject.name + "] does not have an identity transform in space [" +
                           Type + "].");
        }
    }
}

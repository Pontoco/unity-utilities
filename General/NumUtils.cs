...
namespace Utilities
{
  public class NumUtils
  {
    ...
    /// <summary>
    /// Clamps a value to be between the given boundaries, inclusive.
    /// </summary>
    ...
    /// <summary>
    ///  Linearly maps a given value [0,1] to the range start..end. 
    /// </summary>
    /// <param name="clamp">Whether to force the final value to be within start/end or to allow
    /// the linear interpolation to extend outside (if value > 1, for instance). </param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Takes a number (-inf..+inf) and two bounds and maps to 0..1 inside a given bounds.
    /// </summary>
    /// <param name="clamp">Whether to force the final value to be within start/end or to allow
    /// the linear interpolation to extend outside (if value > 1, for instance). </param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Maps a value linearly from one range to another. 
    /// 
    /// Example: 5, (0, 10), (4, 8)
    /// Result: 6
    /// </summary>
